...
JsonChildDevic::JsonChildDevic(const char* Id) :BaseChildDevice(Id), channel(-1), ptzCmd(-1)
{
}
...
void JsonChildDevic::setLastPtzCmd(int cmd)
{
    ptzCmd = cmd;
}
const int JsonChildDevic::getLastPtzCmd()
{
    return ptzCmd;
}
