...
public:
    ...
    bool RequestLiveStream(std::string devId, std::string devIp, int devPort, std::string channelId, int streamId, int sdpPort, int rtpType, UaClientCall* pAleg = NULL);
    ...
    BaseDevice* GetStreamInfo(std::string channelId);
