...
//Response
//catalog 响应
bool CreateCatalogResponse(const char* user, const uint32_t& sn, int SumNum, std::vector<CatalogItem> Items, CatalogItemExpandInfo *pExpand, string& outstr);	//pExpand摄相机使用
